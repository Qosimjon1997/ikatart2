    ...
    <div class="fadeInDown m-auto">
      <div id="formContent">
        ...
        <?php $form = ActiveForm::begin([
            ...
            <small><?= Html::a(Yii::t('app', 'Forgot password?'), ['saler/request-password-reset'], ['class' => 'text-dark d-block text-right']) ?></small>
            ...
            <div class="row my-2">
                ...
                <div class="col">
                    <?= Html::a(Yii::t('app', 'Didn\'t get verification email?'), ['saler/resend-verification-email'], ['class' => 'text-dark text-right']) ?>
                </div>
            </div>

 ...
 * @property Mainproduct[] $mainproducts
...
class Product extends \yii\db\ActiveRecord
{
    ...
    /**
     * Gets query for [[Mainproducts]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getMainproducts()
    {
        return $this->hasMany(Mainproduct::className(), ['product_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Productnamelanguages::className(), ['product_id' => 'id']);
    }
